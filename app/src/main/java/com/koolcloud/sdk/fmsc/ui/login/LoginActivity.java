...
public class LoginActivity extends BaseActivity implements LoginView {
    ...
    @Override
    public void setMerchIdError() {
        merchId.setError(getString(R.string.merch_id_error));
    }
...
//        finish();
    ...
    public void loginBtnClick(View view) {
        presenter.validateCredentials(this, merchId.getText().toString(), username.getText().toString(), password.getText().toString());
    }
}
